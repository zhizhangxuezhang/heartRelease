 ...
 */
public interface PersonalLabelService {
     ...
     * @return 对象列表
     */
    List<PersonalLabel> queryAllByLimit(int offset, int limit);
     ...
     * @return 实例对象
     */
    PersonalLabel insert(PersonalLabel personalLabel);
     ...
     * @return 实例对象
     */
    PersonalLabel update(PersonalLabel personalLabel);
